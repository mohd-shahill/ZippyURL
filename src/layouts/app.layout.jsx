...
const AppLayout = () => {
  return (
    <div>
      ...
      <div className='p-10 text-center bg-blue-950 mt-10'>
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="flex text-xl font-bold">ZippyURL</h2>
            <p className="flex text-sm">© 2024 Your Company. All rights reserved.</p>
          </div>
